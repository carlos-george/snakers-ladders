...
public final class GameServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<br.com.til.models.Die,
      br.com.til.models.GameState> getRollMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "roll",
      requestType = br.com.til.models.Die.class,
      responseType = br.com.til.models.GameState.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<br.com.til.models.Die,
      br.com.til.models.GameState> getRollMethod() {
    io.grpc.MethodDescriptor<br.com.til.models.Die, br.com.til.models.GameState> getRollMethod;
      ...
      synchronized (GameServiceGrpc.class) {
        if ((getRollMethod = GameServiceGrpc.getRollMethod) == null) {
          GameServiceGrpc.getRollMethod = getRollMethod = 
              io.grpc.MethodDescriptor.<br.com.til.models.Die, br.com.til.models.GameState>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "GameService", "roll"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.com.til.models.Die.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.com.til.models.GameState.getDefaultInstance()))
  ...
  public static abstract class GameServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<br.com.til.models.Die> roll(
        io.grpc.stub.StreamObserver<br.com.til.models.GameState> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                br.com.til.models.Die,
                br.com.til.models.GameState>(
                  this, METHODID_ROLL)))
          .build();
    }
  }
  ...
  private static abstract class GameServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return br.com.til.models.GameServiceOuterClass.getDescriptor();
    }
